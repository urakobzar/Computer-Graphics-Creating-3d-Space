...
namespace Lab5
{
    ...
    {
        double[,] bipyramid = new double[5, 4];                     // Матрица фигуры
        ...
        double[,] shiftMatrixToArbitaryAxis = new double[4, 4];     // Матрица смещения на произвольную ось
        ...
        {
            bipyramid[0, 0] = 0; bipyramid[0, 1] = 100; bipyramid[0, 2] = 0; bipyramid[0, 3] = 1;
            bipyramid[1, 0] = 116; bipyramid[1, 1] = 0; bipyramid[1, 2] = 0; bipyramid[1, 3] = 1;
            bipyramid[2, 0] = -58; bipyramid[2, 1] = 0; bipyramid[2, 2] = 100; bipyramid[2, 3] = 1;
            bipyramid[3, 0] = -58; bipyramid[3, 1] = 0; bipyramid[3, 2] = -100; bipyramid[3, 3] = 1;
            bipyramid[4, 0] = 0; bipyramid[4, 1] = -100; bipyramid[4, 2] = 0; bipyramid[4, 3] = 1;
        }
        ...
        private void InitializationAxes()
        {
            ...
            axes[6, 0] = 450;   axes[6, 1] = -450;  axes[6, 2] = 300;   axes[6, 3] = 1;
            axes[7, 0] = 0;     axes[7, 1] = 0;     axes[7, 2] = 0;     axes[7, 3] = 1;
        }

        /// <summary>
        /// Матрица переноса фигуры на произвольную ось (Подсчитана вручную)
        /// </summary>
        private void InitializationShiftMatrixToArbitaryAxis()
        {
            shiftMatrixToArbitaryAxis[0, 0] = 0.7;   
            shiftMatrixToArbitaryAxis[0, 1] = 0.2;   
            shiftMatrixToArbitaryAxis[0, 2] = 0; 
            shiftMatrixToArbitaryAxis[0, 3] = 0;
            shiftMatrixToArbitaryAxis[1, 0] = -0.6;  
            shiftMatrixToArbitaryAxis[1, 1] = 0.5;   
            shiftMatrixToArbitaryAxis[1, 2] = 0; 
            shiftMatrixToArbitaryAxis[1, 3] = 0;
            shiftMatrixToArbitaryAxis[2, 0] = 0;     
            shiftMatrixToArbitaryAxis[2, 1] = 0;    
            shiftMatrixToArbitaryAxis[2, 2] = 1; 
            shiftMatrixToArbitaryAxis[2, 3] = 0;
            shiftMatrixToArbitaryAxis[3, 0] = pictureBox1.Width / 2 + 35;   
            shiftMatrixToArbitaryAxis[3, 1] = 20;
            shiftMatrixToArbitaryAxis[3, 2] = 0; 
            shiftMatrixToArbitaryAxis[3, 3] = 1;
        }
        ...
        private void BipyramidDraw()
        {
            ...
            if (rotationCheck)
            {
                ...
                newBipyramid = MatrixMultiply(bipyramid, rotationMatrix);
            }
            else if (rotationCheckArbitaryAxis)
            {
                InitializationShiftMatrixToArbitaryAxis();
                InitializationRotationMatrix(k, l, m, alpha);
                newBipyramid = MatrixMultiply(bipyramid, rotationMatrix);
                newBipyramid = MatrixMultiply(newBipyramid, shiftMatrixToArbitaryAxis);
            }
            else
            {
                newBipyramid = MatrixMultiply(bipyramid, convertMatrix);
            }
            ...
            cg.DrawLine(myPen, (int)newBipyramid[4, 0], (int)newBipyramid[4, 1],
                (int)newBipyramid[1, 0], (int)newBipyramid[1, 1]);
            cg.DrawLine(myPen, (int)newBipyramid[4, 0], (int)newBipyramid[4, 1],
                (int)newBipyramid[2, 0], (int)newBipyramid[2, 1]);
            cg.DrawLine(myPen, (int)newBipyramid[4, 0], (int)newBipyramid[4, 1],
            ...
            newBipyramid = MatrixMultiply(bipyramid, worldCoordinateMatrix);
